export const MILESTONES = {
        ...
        "WoodenItBeNice": [
            {
                ...
                lore : "Lore Lore Lore",
                icon: "textures/ui/QuestIcons/sapling_oak.png",
                background: "textures/ui/QuestBackgrounds/qaeBlank", 
                slot: 339,
                isHidden: false,
                collections: [
                    {
                        ...
                        displayName: "Test One!",
                        description: "Description One",
                        icon: "textures/ui/QuestIcons/locator.png",                
                        commands: [{}],  // commands to run,                    
                        requirements: [
                            {
                                type: "onBreak",  
    ...
    "CascadeTestMilestone": [
        {
            id: "ctm1",
            type: "milestone",
            level: "test",
            parentId: "CascadeTestMilestone",
            displayName: "Cascade Submission Test",
            description: "Test mixed submit and stat requirements.",
            icon: "textures/ui/icon_test.png",
            slot: 80,
            isHidden: false,
            collections: [
                {
                    ...
                    tier: 1,
                    slot: 90,
                    displayName: "Mixed Requirement Test Tier",
                    description: "Submit 2 dirt, kill 1 zombie, submit 3 logs (any type)",
                    icon: "textures/items/wooden_shovel",
                    keepSubmitted: true,
                    requirements: [
                        {
                            type: "submit",
                    ...
                    rewards: [
                        ...
                        },
                        {
                            type: "message",
                            stage: "complete",
                            content: "CascadeTestMilestone completed!",
                            messageType: "toast"
                        }
                    ]
                }
